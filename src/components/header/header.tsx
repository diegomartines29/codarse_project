...
export const Header= () => {
    ...
    return (
        <>
            <nav className="flex items-center gap-6 justify-start fixed top-0 right-0 left-0 md:justify-center bg-[var(--color-primary)] py-2 sm:py-4 px-6">
                ...
                <div data-open={drawer} tabIndex={drawer ? undefined : -1} onClick={() => setDrawer(false)} className="sm:hidden bg-gradient-to-r from-[var(--color-background)] fixed top-0 left-0 bottom-0 right-0 transition-transform data-[open=false]:-translate-x-full">
